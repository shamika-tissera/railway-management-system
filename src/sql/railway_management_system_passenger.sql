...
CREATE TABLE `passenger` (
  ...
  `credit_available` decimal(5,2) NOT NULL,
  `isPriorityPassenger` tinyint NOT NULL,
...
INSERT INTO `passenger` VALUES ('john43','john\'s password','john@gmail.com','948525528',999.99,1,'John','Smith');
